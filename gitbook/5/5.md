...
|    pageNum    |     Integer     |       当前页数       |   NO   |                         默认页码为1                          |
|   pageSize    |     Integer     |    每页显示记录数    |   NO   |                       默认每页显示10条                       |
|  searchValue  |     String      |       查询参数       |  YES   |                   箱子信息可进行右模糊查询                   |
...
| emptyBoxOrderTimeStart |     String      | 空箱上门下单开始时间 |   NO   |                           日期控件                           |
|  emptyBoxOrderTimeEnd  |     String      | 空箱上门下单结束时间 |   NO   |                           日期控件                           |
| heavyBoxOrderTimeStart |     String      | 重箱提取下单开始时间 |   NO   |                           日期控件                           |
|  heavyBoxOrderTimeEnd  |     String      | 重箱提取下单结束时间 |   NO   |                           日期控件                           |
